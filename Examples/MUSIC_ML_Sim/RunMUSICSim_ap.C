...
//void RunMUSICSim_ap()
{
  ...
  // beam
  string beam = "17F";
  string SRIMbeam = SRIMdir + "17F_in_GasIndex3_406Torr_293K.srim";
  ...
  evap[0] = "p";    SRIMevap[0] = SRIMdir + "1H_in_GasIndex3_406Torr_293K.srim";
  res[0] = "20Ne";   SRIMres[0] = SRIMdir + "20Ne_in_GasIndex3_406Torr_293K.srim";
