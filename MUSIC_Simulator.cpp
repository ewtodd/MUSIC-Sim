...
///////////////////////////////////////////////////////////////////////////////////
void MUSIC_Simulator::SetEvapResAndPart(string ResName, string ResELossFile, 
					string ParName,	string ParELossFile,
					int Color)
{
  if (CurEva>=MaxEva) {
  ...
  EvaR[CurEva]->SetTrajectoryAtt((short)Color);
  ...
  EvaP[CurEva]->SetTrajectoryAtt((short)Color);
